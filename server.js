/*
  Serge Cohen-Uzan — Serveur portfolio + back-office
  ────────────────────────────────────────────────────
  Démarrage : node server.js
  URL site   : http://localhost:3000
  URL admin  : http://localhost:3000/admin/
  Mot de passe : défini dans ADMIN_PASSWORD (env) ou "scu2025" par défaut
*/
...
// Servir les fichiers statiques (site + admin)
